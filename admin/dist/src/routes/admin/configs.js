...
const config = __importStar(require("../../controller/admin/config.controller"));
const router = (0, express_1.default)();
exports.ConfigsRouter = router;
router.get('/get', auth_middleware_1.authHandler, config.get);
// router.post('/',authHandler,config.create);
// router.delete('/',authHandler,config.deleteMany);
// router.get('/:id',authHandler,config.getOne);
router.put('/set', auth_middleware_1.authHandler, config.set);
